                    ...
                    exports["default"] = sweetAlert = swal = function() {
                        ...
                        case "object":
                            ...
                            params.confirmButtonText = params.showCancelButton
                                ? "Confirm"
                                : _modulesDefaultParams2["default"].confirmButtonText;
                        ...
                        var buttonEvents = [
                            "onclick", "onmouseover", "onmouseout", "onmousedown", "onmouseup", "onfocus"
                        ];
 ...
 */
                    sweetAlert.close = swal.close = function() {
                        ...
                        (0, _modulesHandleDom.removeClass)($successIcon.querySelector(".sa-long"),
                            "animateSuccessLong");
 ...
 */
                    var handleButton = function handleButton(event, params, modal) {
                        ...
                        var doneFunctionExists =
                            params.doneFunction && modal.getAttribute("data-has-done-function") === "true";
 ...
 */
                    var handleCancel = function handleCancel(modal, params) {
                        ...
                        var functionHandlesCancel = functionAsStr.substring(0, 9) === "function(" &&
 ...
 */
                    var setFocusStyle = function setFocusStyle($button, bgColor) {
                        ...
                        $button.style.boxShadow =
                            "0 0 2px rgba(" + rgbColor + ", 0.8), inset 0 0 0 1px rgba(0, 0, 0, 0.05)";
                    };
                    ...
                    var openModal = function openModal(callback) {
                        ...
                        if (timer !== "null" && timer !== "") {
                            ...
                            $modal.timeout = setTimeout(function() {
                                    var doneFunctionExists = (timerCallback || null) &&
 ...
 */
                    ...
                    var setParameters = function setParameters(params) {
                        ...
                        $text.innerHTML =
                            params.html
                            ? params.text
                            : (0, _handleDom.escapeHtml)(params.text || "").split("\n").join("<br>");
                        ...
                        if (params.imageUrl) {
                            ...
                            if (params.imageSize) {
                                ...
                                if (!imgWidth || !imgHeight) {
                                    logStr("Parameter imageSize expects value with format WIDTHxHEIGHT, got " +
                                        params.imageSize);
                                } else {
                                    _imgWidth = imgWidth;
