...
( function( $ ) {
  ...
  $.widget( "custom.timeDurationPicker", {
    ...
    _create: function() {
      ...
      this._content.div.addClass( "ui-widget ui-widget-content ui-helper-clearfix ui-corner-all box" );
      ...
      this._content.tableBody = $( "tbody", this._content.table );
        ...
        this._content.button = $( "<input type='button' class='button is-success' />" )
