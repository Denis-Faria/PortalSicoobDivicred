...
<li id="section-1">
    ...
    <div class="content">
        <div class="highlight">
            <pre>(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">global, undefined</span>) </span>{
  ...
  <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">makeInstaller</span>(<span class="hljs-params">options</span>) </span>{
    <span class="hljs-keyword">var</span> root = <span class="hljs-keyword">new</span> File({});</pre>
        </div>
    </div>
...
<li id="section-2">
    <div class="annotation">
        ...
        <p>
            ...
            dependencies. See also <code>queueAppend</code> and <code>queueFlush</code>.
        </p>
    ...
    <div class="content">
        <div class="highlight">
            <pre>    <span class="hljs-keyword">var</span> q = root.q = {};
    q.h = q.t = {}; <span class="hljs-comment">// Queue head, queue tail.</span></pre>
        </div>
    </div>
...
<li id="section-3">
    ...
    <div class="content">
        <div class="highlight">
            <pre>    q.d = options &amp;&amp; options.defer || <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">fn</span>) </span>{
  ...
  <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">queueAppend</span>(<span class="hljs-params">q, file</span>) </span>{</pre>
        </div>
    </div>
...
<li id="section-4">
    <div class="annotation">
        ...
        <p>
            Property names shortened to shave bytes: <code>.t</code> means <code>.tail</code>, <code>.h</code>
            means <code>.head</code>, <code>.n</code> means <code>.next</code>, and <code>.f</code> means <code>.file</code>.
        </p>
    ...
    <div class="content">
        <div class="highlight">
            <pre>    q.t = q.t.n = { f: file };
    <span class="hljs-keyword">if</span> (q.h.n === q.t) {</pre>
        </div>
    </div>
...
<li id="section-5">
  ...
  <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">queueFlush</span>(<span class="hljs-params">q</span>) </span>{</pre>
        </div>
    </div>
...
<li id="section-6">
    <div class="annotation">
        ...
        <p>The <code>q.p</code> property is set to indicate a flush is pending.
        </p>
    ...
    <div class="content">
        <div class="highlight">
            <pre>    q.p || (q.p = <span class="hljs-literal">true</span>, q.d(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
...
<li id="section-7">
    <div class="annotation">
        ...
        <p>
            These <code>unbound{Require,Ensure}</code> functions need to be bound to File
            objects before they can be used. See <code>makeRequire</code>.
        </p>
  ...
  <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">unboundEnsure</span>(<span class="hljs-params"></span>) </span>{</pre>
        </div>
    </div>
...
<li id="section-8">
    <div class="annotation">
        ...
        <p>
            ...
            that array into a callback function with a <code>.d</code> property.
        </p>
    ...
    <div class="content">
        <div class="highlight">
            <pre>    <span class="hljs-keyword">var</span> flatArgs = Ap.concat.apply(Ap, <span class="hljs-built_in">arguments</span>);
    <span class="hljs-keyword">var</span> callback = ensureObjectOrFunction(flatArgs);</pre>
        </div>
    </div>
...
<li id="section-9">
    <div class="annotation">
        ...
        <p>
            Note that <code>queueAppend</code> schedules a flush if there are no other
    ...
    <div class="content">
        <div class="highlight">
            <pre>    queueAppend(<span class="hljs-keyword">this</span>.q, <span class="hljs-keyword">new</span> File(callback, <span class="hljs-keyword">this</span>));
  }
  ...
  <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">makeRequire</span>(<span class="hljs-params">file</span>) </span>{
    ...
    <span class="hljs-built_in">require</span>.ensure = unboundEnsure.bind(file);</pre>
        </div>
    </div>
...
<li id="section-10">
    <div class="annotation">
        ...
        <p>TODO Consider adding <code>require.promise</code>.
        </p>
    ...
    <div class="content">
        <div class="highlight">
            <pre>    <span class="hljs-keyword">return</span> <span class="hljs-built_in">require</span>;
  }</pre>
        </div>
    </div>
...
<li id="section-11">
    ...
    <div class="content">
        <div class="highlight">
            <pre>  <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">File</span>(<span class="hljs-params">contents, <span class="hljs-comment">/*optional:*/</span> parent, name</span>) </span>{
    <span class="hljs-keyword">var</span> file = <span class="hljs-keyword">this</span>;</pre>
        </div>
    </div>
...
<li id="section-12">
    ...
    <div class="content">
        <div class="highlight">
            <pre>    file.p = parent = parent || <span class="hljs-literal">null</span>;

    <span class="hljs-keyword">if</span> (name) {</pre>
        </div>
    </div>
...
<li id="section-13">
    <div class="annotation">
        ...
        <p>
            If this file was created with <code>name</code>, join it with <code>parent.id</code> to
    ...
    <div class="content">
        <div class="highlight">
            <pre>      file.id = (parent &amp;&amp; parent.id || <span class="hljs-string">""</span>) + <span class="hljs-string">"/"</span> + name;
    }</pre>
        </div>
    </div>
...
<li id="section-14">
    <div class="annotation">
        ...
        <p>
            ...
            inherited from the <code>parent</code>.
        </p>
    ...
    <div class="content">
        <div class="highlight">
            <pre>    file.q = parent &amp;&amp; parent.q;</pre>
        </div>
    </div>
...
<li id="section-15">
    <div class="annotation">
        ...
        <p>
            Each directory has its own bound version of the <code>require</code> function
...
<li id="section-16">
    <div class="annotation">
        ...
        <p>Set the initial value of <code>file.c</code> (the “contents” of the File).
        </p>
    ...
    <div class="content">
        <div class="highlight">
            <pre>    fileMergeContents(file, contents);</pre>
        </div>
    </div>
...
<li id="section-17">
    <div class="annotation">
        ...
        <p>
            When the file is a directory, <code>file.ready</code> is an object mapping
    ...
    <div class="content">
        <div class="highlight">
            <pre>    file.ready = fileIsDirectory(file) &amp;&amp; {};
  }</pre>
        </div>
    </div>
...
<li id="section-18">
    ...
    <div class="content">
        <div class="highlight">
            <pre>  <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">fileReady</span>(<span class="hljs-params">file</span>) </span>{
    ...
    <span class="hljs-keyword">if</span> (deps &amp;&amp; ! getOwn(<span class="hljs-built_in">module</span>, <span class="hljs-string">"seen"</span>)) {
      ...
      result = <span class="hljs-built_in">Object</span>.keys(deps).every(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">dep</span>) </span>{</pre>
        </div>
    </div>
...
<li id="section-19">
    <div class="annotation">
        ...
        <p>
            By storing the results of these lookups in <code>parentReadyCache</code>,
    ...
    <div class="content">
        <div class="highlight">
            <pre>        <span class="hljs-keyword">return</span> parentReadyCache[dep] =
  ...
  <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">ensureObjectOrFunction</span>(<span class="hljs-params">contents</span>) </span>{</pre>
        </div>
    </div>
...
<li id="section-20">
    <div class="annotation">
        ...
        <p>
            ...
            function with a <code>.d</code> property containing all the strings.
        </p>
    ...
    <div class="content">
        <div class="highlight">
            <pre>    <span class="hljs-keyword">if</span> (<span class="hljs-built_in">Array</span>.isArray(contents)) {
...
<li id="section-21">
    ...
    <div class="content">
        <div class="highlight">
            <pre>      contents = func || <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">module, require</span>) </span>{
        <span class="hljs-built_in">Object</span>.keys(deps).forEach(<span class="hljs-built_in">require</span>);
      };

      contents.d = deps;

    } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (isFunction(contents)) {</pre>
        </div>
    </div>
...
<li id="section-22">
    ...
    <div class="content">
        <div class="highlight">
            <pre>      contents.d = contents.d || {};

    } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (! isObject(contents)) {</pre>
        </div>
    </div>
...
<li id="section-23">
    ...
    <div class="content">
        <div class="highlight">
            <pre>      contents = <span class="hljs-literal">null</span>;
    }

    <span class="hljs-keyword">return</span> contents;
  }

  <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">fileAppendIdPart</span>(<span class="hljs-params">file, part, isLastPart</span>) </span>{</pre>
        </div>
    </div>
...
<li id="section-24">
    ...
    <div class="content">
        <div class="highlight">
            <pre>    <span class="hljs-keyword">while</span> (file &amp;&amp; ! fileIsDirectory(file)) {
      file = file.p;
    }
    ...
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> e = <span class="hljs-number">0</span>; e &lt; extensions.length; ++e) {
      ...
      <span class="hljs-keyword">if</span> (! isLastPart) {</pre>
        </div>
    </div>
...
<li id="section-25">
    <div class="annotation">
        ...
        <p>
            ...
            part of a module identifier, and not <code>.</code> or <code>..</code>.
        </p>
    ...
    <div class="content">
        <div class="highlight">
            <pre>        <span class="hljs-keyword">break</span>;
      }
    }
  };
  ...
  <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">fileAppendId</span>(<span class="hljs-params">file, id</span>) </span>{
    <span class="hljs-keyword">var</span> parts = id.split(<span class="hljs-string">"/"</span>);</pre>
        </div>
    </div>
...
<li id="section-26">
    <div class="annotation">
        ...
        <p>
            Use <code>Array.prototype.every</code> to terminate iteration early if
            <code>fileAppendIdPart</code> returns a falsy value.
        </p>
    ...
    <div class="content">
        <div class="highlight">
            <pre>    parts.every(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">part, i</span>) </span>{
...
<li id="section-27">
    <div class="annotation">
        ...
        <p>
            Absolute module identifiers (i.e. those that begin with a <code>/</code>
    ...
    <div class="content">
        <div class="highlight">
            <pre>      id.charAt(<span class="hljs-number">0</span>) === <span class="hljs-string">"/"</span> ? fileAppendId(fileGetRoot(file), id) :</pre>
        </div>
    </div>
...
<li id="section-28">
    ...
    <div class="content">
        <div class="highlight">
            <pre>      id.charAt(<span class="hljs-number">0</span>) === <span class="hljs-string">"."</span> ? fileAppendId(file, id) :</pre>
        </div>
    </div>
...
<li id="section-29">
    <div class="annotation">
        ...
        <p>
            ...
            packages in <code>node_modules</code> directories.
        </p>
    ...
    <div class="content">
        <div class="highlight">
            <pre>      nodeModulesLookup(file, id);</pre>
        </div>
    </div>
...
<li id="section-30">
    <div class="annotation">
        ...
        <p>
            ...
            Node to find an <code>index.js</code> or <code>package.json</code> file to evaluate.
        </p>
    ...
    <div class="content">
        <div class="highlight">
            <pre>    <span class="hljs-keyword">while</span> (file &amp;&amp; fileIsDirectory(file)) {</pre>
        </div>
    </div>
...
<li id="section-31">
    <div class="annotation">
        ...
        <p>
            If <code>package.json</code> does not exist, <code>fileEvaluate</code> will return the
            <code>MISSING</code> object, which has no <code>.main</code> property.
        </p>
    ...
    <div class="content">
        <div class="highlight">
            <pre>      <span class="hljs-keyword">var</span> pkg = fileEvaluate(fileAppendIdPart(file, <span class="hljs-string">"package.json"</span>));
  ...
  <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">nodeModulesLookup</span>(<span class="hljs-params">file, id</span>) </span>{
   ...
   <span class="hljs-string">"object"</span> === <span class="hljs-keyword">typeof</span> self ? self : <span class="hljs-keyword">this</span>);</pre>
        </div>
    </div>
