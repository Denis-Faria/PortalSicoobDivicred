...
namespace PortalSicoobDivicred.Models
{
    public class Usuario
    {
      ...
      [DisplayName("Data Nascimento")]
        ...
        [DisplayName("Primeira Cnh")]
        public string PrimeiraCnh { get; set; }


        [DisplayName("Quantidade Filhos")]
        public string QuantidadeFilho { get; set; }


        [DisplayName("Tipo Escolaridade")]
        public List<SelectListItem> IdTipoEscolaridade { get; set; }

        public int? TipoEscolaridade { get; set; }


        [DisplayName("Nome da Instituição")]
        public List<string> NomeInstituicao { get; set; }
        ...
        [DisplayName("Ano de Inicio")]
        public List<string> AnoInicio { get; set; }
        ...
        public List<string> NomeCargo { get; set; }


        [DisplayName("Data Entrada")]
        public List<string> DataEntrada { get; set; }


        [DisplayName("Data Saida")]
        public List<string> DataSaida { get; set; }
