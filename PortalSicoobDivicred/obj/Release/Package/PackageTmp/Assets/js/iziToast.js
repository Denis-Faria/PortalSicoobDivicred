    ...
    function(root) {
            ...
            var progressBar = {
                ...
                updateProgress: function() {
                    ...
                    if (!is.Paused && !is.Reseted && !is.Closed) {
                        ...
                        var percentage = ((progressBar.hideEta - (progressBar.currentTime)) / progressBar.maxHideTime) *
                            100;
        ...
        $iziToast.hide = function(options, $toast, closedBy) {
            ...
            try {
                ...
                var event = new CustomEvent(PLUGIN_NAME + "-close",
                    { detail: settings, bubles: true, cancelable: true });
        ...
        $iziToast.show = function(options) {
            ...
            try {
                var event = new CustomEvent(PLUGIN_NAME + "-open",
                    { detail: settings, bubles: true, cancelable: true });
                document.dispatchEvent(event);
            } catch (ex) {
                console.warn(ex);
